...
[Deploy BreadWinner on Railway — preview](https://railway.com/deploy/rNhJ3h)
...
1. Open the **Deploy BreadWinner on Railway** link above, sign in to Railway, and select your workspace. Your Railway account pays for hosting, database storage, and saved creative files. Check [Railway pricing](https://railway.com/pricing) before deploying.
