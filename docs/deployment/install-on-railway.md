...
Once the verified template is published, your installation follows these steps:

1. Open **Deploy on Railway**, sign in to Railway, and select a plan. Your Railway account pays for hosting, database storage, and saved creative files. Check [Railway pricing](https://railway.com/pricing) before deploying.
2. Enter your owner email and password. The password needs at least 12 characters and at most 72 UTF-8 bytes. Save it in your password manager.
...
5. Add your brand and product. A photo is optional. Describe the audience and offer, then choose **Generate one ad**. This step can incur AI-provider charges.
