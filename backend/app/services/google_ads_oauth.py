"""Pure helpers for the Google Ads OAuth flow (httpx). State/CSRF handling
uses the shared app.core.oauth_state, the mechanism every platform OAuth
flow in this app shares.
"""
